        ...
        */
        ...
        void lock_shared() noexcept
        {
            ...
            for ( size_t try_count = 1; ; ++try_count )
            {
                ...
                s_lock.atomic_.fetch_add( 1, memory_order_acq_rel );
                
                // if there is not exclusive lock request
                if ( ! x_lock_.atomic_.load( memory_order_acquire ) )
                {
                ...
                s_lock.atomic_.fetch_sub( 1, memory_order_acq_rel );
        ...
        */
        ...
        void lock_upgrade()
        {
            ...
            for ( size_t lock_ndx = 0; lock_ndx < SharedLockHasher; ++lock_ndx )
            {
                ...
                {
                    // wait until a shared lock gets released
                    if ( allowed_shared_lock_count == s_lock.atomic_.load( memory_order_acquire ) )
                    {
                        break;
                    }
    ...
    public:
        ...
        */
        ...
        public:
            ...
            */
            ...
            @throw nothing
            */
            shared_lock( rare_write_frequent_read_mutex & mutex ) noexcept : mutex_( &mutex )
            {
                assert( mutex_ );
            ...
            */
            template < size_t SpinCount >
            void swap( shared_lock< SpinCount> & other ) noexcept
            {
        ...
        */
        ...
        public:
            ...
            */
            ...
            @throw nothing
            */
            unique_lock( rare_write_frequent_read_mutex & mutex ) noexcept : mutex_( &mutex )
            {
                assert( mutex_ );
            ...
            */
            template< size_t SpinCount >
            void swap( unique_lock< SpinCount > & other ) noexcept
            {
                std::swap( mutex_, other.mutex_ );
            }
        ...
        */
        ...
        public:
            ...
            */
            template< size_t SpinCount >
            upgrade_lock( const shared_lock< SpinCount > & shared_lock ) noexcept : mutex_( shared_lock.mutex_ )
            {
            ...
            */
            template< size_t SpinCount >
            void swap( upgrade_lock< SpinCount > & other ) noexcept
            {
                std::swap( mutex_, other.mutex_ );
            }
